...
const Counter = ({ icon, start, end, duration, label, prefix = "", suffix = "", }) => {
    ...
    return (_jsxs("div", { ref: ref, className: "flex flex-col items-center text-center bg-black p-6 rounded-lg", children: [_jsx("i", { className: `text-4xl text-white ${icon}` }), _jsxs("div", { className: "relative mt-2", children: [_jsxs("div", { className: "text-3xl font-bold text-white", children: [prefix, count, suffix] }), _jsx("span", { className: "absolute top-0 right-[-10px] transform translate-y-[-50%] text-sm text-white font-bold", children: "+" })] }), _jsx("p", { className: "text-[#FFD700]", children: label })] }));
};
const StatsSection = () => {
